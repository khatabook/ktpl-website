...
export function MerchantCards() {
  ...
  const codeExamples = {
    cURL: {
      code: `# Create a payment link
curl -X POST https://api.khatabookpayments.com/v1/payments \\
...
# Response will include payment link URL`,
      language: 'bash',
...
const isValid = verifyWebhookSignature(
  request.body,
  request.headers['x-khatabook-signature'],
  process.env.KHATABOOK_WEBHOOK_SECRET
);
...
if (isValid) {
  ...
  console.log('Invalid webhook signature');
    ...
    Python: {
      code: `# Refund an order
import requests
import json

def refund_order(order_id, amount, reason="customer_request"):
    url = f"https://api.khatabookpayments.com/v1/orders/{order_id}/refunds"
    ...
    payload = {
        "amount": amount,  # Amount in paise (e.g., 1000 = ₹10.00)
        "reason": reason,
        "notes": "Refund processed as requested"
    }
    ...
    if response.status_code == 200:
        ...
        print(f"Refund successful: {refund_data['refund_id']}")
        return refund_data
    else:
  ...
  return (
    <div className="py-30 bg-white dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="w-full py-30 mt-20">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Clean REST APIs, event-driven webhooks, idempotency, sample apps, and a robust sandbox so you can ship fast.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <CodeBlock>
                {/* File header tab */}
                <div className="flex flex-col border-b border-border bg-muted rounded-t-xl">
                  {/* Window controls and file info */}
                  <div className="flex items-center justify-between px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2 ml-4">
                        <span className="text-sm text-muted-foreground">{codeExamples[activeTab as keyof typeof codeExamples].filename}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <button
                ...
                <div className="max-h-96 overflow-y-auto">
                  <CodeBlockCode
                    ...
                    language={codeExamples[activeTab as keyof typeof codeExamples].language}
                  />
                </div>
              </CodeBlock>
            </div>
