...
import { Shield, Lock, Eye, Zap, Users } from 'lucide-react'
            ...
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 border border-gray-200 dark:border-gray-700 shadow-none">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold text-[#DC3444]">100%</span>
                                </div>
                                <h2 className="mt-6 text-center text-3xl font-semibold text-gray-900 dark:text-white">Secure</h2>
                            </CardContent>
                        </Card>
                        
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border border-gray-200 dark:border-gray-700 shadow-none">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border bg-[#DC3444]/10 before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <Shield className="m-auto h-16 w-16 text-[#DC3444]" strokeWidth={1.5} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">PCI-DSS compliant</h3>
                                    <p className="text-gray-600 dark:text-gray-300 text-sm">
                                        Industry-standard security protocols for payment processing with comprehensive compliance.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="386" height="123" rx="10" className="fill-gray-100 dark:fill-gray-800" />
                                        <g clipPath="url(#clip0_0_106)">
                                            <circle className="text-[#DC3444]" cx="29" cy="29" r="15" fill="currentColor" />
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-[#DC3444]/15" stopColor="currentColor" />
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">3-D Secure & tokenization</h3>
                                    <p className="text-gray-600 dark:text-gray-300 text-sm">
                                        Advanced authentication and network tokenization for secure transactions.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 border border-gray-200 dark:border-gray-700 shadow-none">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border bg-[#DC3444]/10 before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Eye className="m-auto size-6 text-[#DC3444]" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-2">
                                        <h3 className="text-lg font-medium text-gray-900 dark:text-white">RBI-aligned governance</h3>
                                        <p className="text-gray-600 dark:text-gray-300 text-sm">
                                            Regulatory compliance with Reserve Bank of India guidelines and controls.
                                        </p>
                                    </div>
                                </div>
                                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                                    <div className="absolute left-3 top-2 flex gap-1">
                                        <span className="block size-2 rounded-full border bg-[#DC3444] dark:border-white/10 dark:bg-white/10"></span>
                                        <span className="block size-2 rounded-full border bg-[#DC3444] dark:border-white/10 dark:bg-white/10"></span>
                                        <span className="block size-2 rounded-full border bg-[#DC3444] dark:border-white/10 dark:bg-white/10"></span>
                                    </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 border border-gray-200 dark:border-gray-700 shadow-none">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border bg-[#DC3444]/10 before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Zap className="m-auto size-6 text-[#DC3444]" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-2">
                                        <h3 className="text-lg font-medium text-gray-900 dark:text-white">Real-time fraud detection</h3>
                                        <p className="text-gray-600 dark:text-gray-300 text-sm">
                                            Instant fraud monitoring and transaction velocity controls for maximum security.
                                        </p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-[#DC3444]/10 text-[#DC3444]">Encrypted</span>
                                            <div className="ring-background size-7 ring-4">
                                                <Lock className="size-full rounded-full p-1 text-[#DC3444]" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4">
                                                <Shield className="size-full rounded-full p-1 text-[#DC3444]" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-[#DC3444]/10 text-[#DC3444]">Protected</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-[#DC3444]/10 text-[#DC3444]">Secure</span>
                                            <div className="ring-background size-7 ring-4">
                                                <Eye className="size-full rounded-full p-1 text-[#DC3444]" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="mt-12 text-center">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        Note: Data is encrypted in transit and at rest.
                    </p>
                </div>
            </div>
        </section>
